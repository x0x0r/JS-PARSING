...
def main():
    ...
    # Input debug/verbose
    debug = input("🔧 Aktifkan mode debug/verbose? (y/n): ").strip().lower() == 'y'
    ...
    logging.debug(f"✅ Selesai scan {len(urls)} link.")
    logging.debug(f"📁 Output disimpan di: {output_dir}")
